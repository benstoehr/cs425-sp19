...
response = server.SayHi(mp3_pb2.HelloRequest(name='test2'))
...
#                         beginreply = server.begin(mp3_pb2.beginMessage(name="Client2"))
#                         print(beginreply.message)

#                 if('COMMIT' in command):
#                     for server in serverDict.values():
#                         commitreply = server.commit(mp3_pb2.beginMessage(name="Client2"))
...
#                     getreply = serverDict[server].getValue(mp3_pb2.getMessage(name="Client2", serverkey=str(serverkey)))
...
#                     setreply = serverDict[server].setValue(mp3_pb2.setMessage(name="Client2", serverkey=serverkey, value=value))
...
#     response = serverDict['A'].setValue(mp3_pb2.setMessage(name='Client 2', serverkey='A.x', value='1'))
...
#     # response = serverDict['B'].setValue(mp3_pb2.setMessage(name='Client 2', serverkey='B.x', value='1'))
#     # print("setValue received: " + response.message)

#     response = serverDict['B'].getValue(mp3_pb2.getMessage(name='Cleint 2', serverkey='B.x'))
#     print("getValue received: " + response.message)
